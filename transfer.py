...
POLYGON_API_TOKEN = 'you_api'

# Генерация случайного значения MINIMUM_BALANCE с шагом 0.001
MINIMUM_BALANCE = round(random.uniform(1.0, 1.2), 3)
...
def main():
    ...
    for i in range(min(threads, len(private_keys))):
        ...
        threading.Thread(target=send_transaction, args=(private_key, to_address, amount, gas_price, MINIMUM_BALANCE, MINIMUM_MATIC_AMOUNT)).start()
